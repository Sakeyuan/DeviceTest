...
#if defined(VXWORKS)    // Add 2007-02-07

#if !defined(S_MT_SUPPORT)
#define S_MT_SUPPORT
#endif

#define GET_THREAD_ID()		taskIdSelf()
#define ST_MUTEX_SEM 		SEM_ID
#define ST_EVENT_SEM 		SEM_ID
#define ST_THREAD_ID 		int
#define ST_THREAD_HANDLE 	int
