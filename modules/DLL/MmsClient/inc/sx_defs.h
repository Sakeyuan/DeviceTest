...
#define SX_ELF_CSTART   	0x0001  // 元素开始时调用函数
#define SX_ELF_CEND	        0x0002  // 元素结束时调用函数
#define SX_ELF_CSTARTEND	0x0003

#define SX_ELF_RPT	        0x0008  // 允许重复(repeat)
#define SX_ELF_OPT	        0x0004  // 可选(option)
#define SX_ELF_OPTRPT		0x000C

#define SX_ELF_EMPTYOK		0x0010  // 允许空
...
ST_RET sx_parseEx_mt (ST_CHAR *fileName, ST_INT numItems, 
                 ...
                 ST_RET (*u_sx_el_start_fun) (SX_DEC_CTRL *sxDecCtrl, ST_CHAR *tag),
                 ST_RET (*u_sx_el_end_fun) (SX_DEC_CTRL *sxDecCtrl, ST_CHAR *tag));
ST_RET sx_parseExx_mt (ST_CHAR *fileName, ST_CHAR *xmlbuf, ST_INT xmlbufLen, ST_INT numItems,
		   SX_ELEMENT *itemTbl, ST_VOID *usr,
                   ST_RET (*u_sx_el_start_fun) (SX_DEC_CTRL *sxDecCtrl, ST_CHAR *tag),
                   ST_RET (*u_sx_el_end_fun) (SX_DEC_CTRL *sxDecCtrl, ST_CHAR *tag));
